...
L["show_static_pop_tips"] = "By default, when the loading conditions are met, a prompt window will be displayed in the bottom right corner of the screen. If this option is checked, a system pop-up window will be displayed, and the priority of this addon loading scheme will be significantly increased"
...
L["configuration_switch_text"] = "A more suitable addoin loading scheme is detected in the current scenario\n|cff00ff00%s|r\nDo you want to switch?"
