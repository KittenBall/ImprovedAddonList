...
L["configuration_switch_ignore"] = "Do not remind again"
L["configuration_switch_ignore_tips"] = "You will no longer be prompted to switch addon loading schemes before the next UI reload"
