...
L["settings_load_indicator_color_unloadable"] = "Unloaded Due to Error Color"
L["settings_load_indicator_color_unloadable_description"] = "Color value for addons that cannot be loaded due to errors"
...
L["addon_set_choice_merge_tips"] = "Merge into selected addon set, current addon list"
L["addon_set_choice_replace_tips"] = "Replace selected addon set with current addon list"
L["addon_set_choice_delete_tips"] = "Remove from selected addon set, current addon list"
