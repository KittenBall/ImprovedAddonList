...
L["settings_addon_set_load_condition_prompt_position_save"] = "Position Memory"
L["settings_addon_set_load_condition_prompt_position_save_tooltip"] = "Enable or disable the memory of the position for the addon set load condition prompt dialog"
